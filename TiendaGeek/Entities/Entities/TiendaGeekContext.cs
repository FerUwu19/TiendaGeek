...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CodigoCarrito).HasName("PK__Carrito__20E75EFA20BBEA31");
        ...
        {
            entity.HasKey(e => e.CodigoImagen).HasName("PK__ImagenPr__B3306E29574CCE4D");
        ...
        {
            entity.HasKey(e => e.CodigoOrden).HasName("PK__Orden__1B9107A5A2DAACAA");
        ...
        {
            entity.HasKey(e => e.CodigoProducto).HasName("PK__Producto__785B009EF219F6EF");
        ...
        {
            entity.HasKey(e => e.CodigoUsuario).HasName("PK__Usuario__F0C18F58F45A355D");
